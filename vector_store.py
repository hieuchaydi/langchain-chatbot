...
# • Hàm chính: add_documents(file_content, filename)
# •              query_documents(query, n_results=8) → (docs, metas)
# •              reset_vectorstore() để xóa sạch DB
# • Lưu trữ: ./vectorstore (persistent)
